package pornnatcha.easywallet.adapter;
...
import pornnatcha.easywallet.R;
...
public class WalletListAdapter extends ArrayAdapter<WalletItem> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView WalletImageView = (ImageView) itemLayout.findViewById(R.id.wallet_image_view);
        TextView WalletTitleTextView = (TextView) itemLayout.findViewById(R.id.wallet_title_text_view);
        TextView WalletNumberTextView = (TextView) itemLayout.findViewById(R.id.wallet_text_view);

        WalletTitleTextView.setText(item.title);
        WalletNumberTextView.setText(item.money);
